...
- **pr:** https://github.com/lerboi/plagiacheck/pull/new/auto/fe-12-export (set base to `auto/fix-home-viewport-fill` for a clean diff against the hand-fix; the chain back to `main` is the same stack as FE-04..FE-11)
...
- **pr:** https://github.com/lerboi/plagiacheck/pull/new/auto/fe-23-token-cost (set base to `auto/fe-22-copy-assistant`)
...
- **pr:** https://github.com/lerboi/plagiacheck/pull/new/auto/fe-19-regenerate (set base to `auto/fe-18-edit-message`)
- **files:** `components/plagia-ai/PlagiaAiApp.tsx`
