  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="py-12 max-w-3xl">
        ...
        <p className="text-lg mb-4">
          The Service is provided &ldquo;as is&rdquo; and &ldquo;as available.&rdquo; We do not warrant that the Service will be error-free, uninterrupted, or secure. To the maximum extent permitted by law, we disclaim all warranties, express or implied, regarding the Service.
        </p>
        <p className="text-lg mb-4">
        ...
        <p className="text-lg mb-4">
          We reserve the right to modify these Terms at any time. Any changes will be posted on this page with an updated &ldquo;Last Updated&rdquo; date. Your continued use of the Service after any such changes constitutes your acceptance of the revised Terms.
        </p>
