...
export function Nav() {
  ...
  const tools = [
    ...
    },
    {
      ...
      href: "/text-to-speech",
      icon: Volume2,
      desc: "Listen to text read aloud",
      color: "text-sky-500",
